...
// aside) is spec'd in ui-spec-v13.md §2 and exercised through the app's page tests.
// It used to say v02 §9.3, which is a section this repo has never had — see
// v13 §0.1 for how four components ended up citing one.
