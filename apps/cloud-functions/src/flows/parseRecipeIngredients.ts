...
const SYSTEM_INSTRUCTIONS = [
  ...
  `  (e.g. "2 cloves garlic" → quantity 2, unit null, item "garlic clove", displayText "about 6g").`,
  ...
  `  A CLOVE of garlic is the same shape and takes the same treatment, in BOTH the`,
  `  wordings recipes use — with "of" and without. One example per line:`,
  `    "1 clove garlic" → item "garlic clove", preparation []`,
  `    "2 cloves of garlic, crushed" → item "garlic clove", preparation ["crushed"]`,
  `    "1 small clove of garlic, grated" → item "garlic clove", preparation ["grated"]`,
  ...
  `  preparation ["crushed"], displayText "about 6g". A bulb holds roughly a dozen cloves, but`,
