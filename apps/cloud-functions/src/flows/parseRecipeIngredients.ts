...
const SYSTEM_INSTRUCTIONS = [
  ...
  `  proteins. Every other count/pack ingredient — garlic cloves, onions, rashers of bacon, tins,`,
  `  packets, bunches, whole vegetables and fruit — still flattens to metric grams as above.`,
  ...
  `  (the UI renders weight-first, e.g. "240g flour (2 cups)" or "150g carrots (about 2 medium)").`,
  `  • For non-metric MEASURES, keep the exact measure verbatim: "½ tsp", "1 cup", "2 tbsp", "3 oz".`,
  ...
  `  Set to null when the source is already in g, kg, ml, or l, or when the line states no amount.`,
  ``,
  `## Metric conversion`,
