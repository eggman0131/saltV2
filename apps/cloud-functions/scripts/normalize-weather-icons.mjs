...
// uniform margins (see src/imaging/normalizeIconFraming.ts for the why/how).
//
// Run from the cloud-functions package dir. Needs tsx (a devDependency, no API
// key) because the normaliser it shares with the canon-icon runtime pipeline is
// TypeScript under src/:
//
//   cd apps/cloud-functions
//   npx tsx scripts/normalize-weather-icons.mjs            # all committed *.webp
//   npx tsx scripts/normalize-weather-icons.mjs clear-day  # a subset of ids
//
