...
| [docs/canon-icons.md](docs/canon-icons.md)                                                             | `apps/cloud-functions/src/triggers/onCanonItemWritten.ts`, `apps/cloud-functions/src/triggers/onProductFormWritten.ts`, `apps/cloud-functions/src/imaging/**`  | Tier-1 pictograms for canon items **and product forms** (#871) — generation pipeline, storage, rendering, and the verbatim prompt (reproduce exactly).                                                                                                 |
