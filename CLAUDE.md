...
| [docs/formulas-schedules-batches.md](docs/formulas-schedules-batches.md)                               | `packages/domain/src/formula/**`, `packages/domain/src/process/**`, `packages/domain/src/batch/**`, `packages/domain/src/culture/**`                           | **Not yet built (Epic #778).** Bread scaling, ferments and cures: the formula/process/batch contract, the scale-is-maths / adapt-is-AI seam, and why no `bread` kind. Read before designing any part of it.                                            |
...
- **ui-spec-v02 → v07 are cumulative, never superseding.** v0.2 holds the
