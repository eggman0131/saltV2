# Graph Report - agent-a5797121b57970622  (2026-06-29)

## Corpus Check
- 855 files · ~321,344 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4071 nodes · 8002 edges · 331 communities (268 shown, 63 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 125 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `93bfdda3`
...
## Communities (331 total, 63 thin omitted)

### Community 0 - "Community 0"
Cohesion: 0.06
Nodes (83): addAttendee(), DayContainer, removeAttendee(), setAttendeeHomeTime(), setAttendeeNote(), setDayChefs(), setDayGuests(), setDayNote() (+75 more)
...
Cohesion: 0.07
Nodes (37): base, approveCanonItem(), renameCanonItem(), setCanonItemSynonyms(), ../../lib/canonService.js, aisles, aisleUsage, approveCanonItemWithOverrides() (+29 more)
...
Cohesion: 0.07
Nodes (19): AISLES, BASE, BASE, CreateAislesBulkInput, deleteAisles(), DeleteAislesInput, ItemMergeChoice, mergeAisles() (+11 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (46): addItem(), createList(), deleteList(), editItemAmountUnit(), renameList(), setDefaultList(), uncheckItem(), get() (+38 more)

### Community 9 - "Community 9"
Cohesion: 0.11
Nodes (38): addAccessory(), addEquipment(), addRule(), editRule(), removeAccessory(), removeEquipment(), removeRule(), renameEquipment() (+30 more)
...
Cohesion: 0.09
Nodes (17): catalog, ApproveCanonItemOverrides, CreateCanonItemInput, ArbitrationExtras, setCanonItemAisle(), setCanonItemShoppingBehavior(), setCanonItemThreshold(), setCanonItemThumbnail() (+9 more)
...
Cohesion: 0.11
Nodes (15): seedEquipmentManifest(), subscribeAisles(), deleteCanonItem(), saveEquipmentManifest(), subscribeEquipmentManifest(), clearFirestoreEmulator(), initFirebaseEmulator(), resetDefaultApp() (+7 more)
...
Cohesion: 0.11
Nodes (24): ../../lib/recipeService.js, applySnapshot(), authorRecipeTraced(), buildRecipeAddPlan(), canonicaliseIngredients(), getErrorReporter(), hostForSpan(), importRecipeFromUrl() (+16 more)
...
Cohesion: 0.10
Nodes (23): embedTextFlow, generateCanonIconFlow, removeFlatBackground(), RemoveFlatBackgroundOptions, sampleBackgroundColour(), reportServerError(), armCfTelemetry(), readiness (+15 more)
...
Cohesion: 0.11
Nodes (25): fakeStore(), AddAccessoryInput, AddEquipmentInput, AddRuleInput, DeleteListInput, EditRuleInput, RemoveAccessoryInput, RemoveEquipmentInput (+17 more)

### Community 34 - "Community 34"
Cohesion: 0.07
Nodes (25): beforeMemberCreated, posthogApiKey, regenerateCanonIcon, arbitrateCanonFlow, generateChatTitleFlow, identifyEquipmentFlow, populateEquipmentEntryFlow, registerGenkitDevTracing() (+17 more)
...
Cohesion: 0.15
Nodes (15): CreateAisleInput, mergeCanonItems(), unionSynonyms(), RenameAisleInput, ConflictStrategy, resolveCanonConflict(), MatchCandidate, MatchStage (+7 more)
...
Cohesion: 0.10
Nodes (30): ensureObservabilityInitialised(), captureServerEvent(), captureServerException(), flushServerObservability(), initServerObservability(), isServerObservabilityInitialised(), ObservabilitySpan, OTEL_SPAN (+22 more)

### Community 47 - "Community 47"
Cohesion: 0.23
Nodes (15): ../../lib/appSettingsService.js, buildNext(), buildNextFlow(), currentDoc(), effectiveFlowModels, effectiveModels, _isCorrupt, _isLoading (+7 more)
...
Cohesion: 0.13
Nodes (15): aiOtlpSpanProcessor, embedInputPreview(), flushAiOtlp(), inFlight, inputMessages(), outputMessages(), parseJson(), postSpan() (+7 more)
...
Cohesion: 0.20
Nodes (10): ShoppingListsConfig, initShoppingListSync(), ShoppingListsConfigPort, loadShoppingListsConfig(), saveShoppingListsConfig(), subscribeShoppingListsConfig(), CONFIG, ErrorCallback (+2 more)
...
Cohesion: 0.12
Nodes (30): encodeAttr(), flushDistributedOtlp(), hasGenkitAttribute(), inFlight, instrumentationScopeName(), shouldShipDistributed(), toDistributedOtlpSpan(), Attribute (+22 more)
...
Cohesion: 0.10
Nodes (25): initMealPlanSync(), TestModelOutcome, loadChatSession(), setAiStub(), callIdentifyEquipment(), callPopulateEquipmentEntry(), IdentifyEquipmentCandidate, IdentifyEquipmentResult (+17 more)
...
Cohesion: 0.09
Nodes (30): classifyFirestoreError(), firestoreCode(), deleteRecipe(), loadRecipe(), saveRecipe(), subscribeRecipes(), deleteShoppingListItem(), deleteShoppingListItems() (+22 more)
...
Cohesion: 0.07
Nodes (41): AddItemInput, clearCheckedItems(), confirmItemNeeded(), ConfirmItemNeededInput, CreateListInput, deleteItem(), DeleteItemInput, EditItemAmountUnitInput (+33 more)
...
Cohesion: 0.31
Nodes (17): createAisle(), createAislesBulk(), ../../lib/aisleService.js, addAisle(), addAislesBulk(), deleteAisles(), idGen, mergeAisles() (+9 more)
...
Cohesion: 0.09
Nodes (20): mockGet, initAppSettingsSync(), ../../lib/devSettingsService.js, canonIconGenerationEnabled, DEFAULTS, initDevSettingsSync(), _isLoading, setCanonIconGenerationEnabled() (+12 more)
...
- **Why does `NavItem` connect `Community 44` to `Community 21`?**
  _High betweenness centrality (0.149) - this node is a cross-community bridge._
- **Why does `../../lib/recipeService.js` connect `Community 24` to `Community 2`, `Community 3`, `Community 8`, `Community 266`, `Community 11`, `Community 145`, `Community 20`, `Community 33`, `Community 162`, `Community 43`, `Community 50`, `Community 51`, `Community 192`, `Community 82`, `Community 89`, `Community 90`, `Community 95`, `Community 98`, `Community 100`, `Community 107`, `Community 108`?**
  _High betweenness centrality (0.072) - this node is a cross-community bridge._
- **Why does `DomainError` connect `Community 33` to `Community 0`, `Community 2`, `Community 3`, `Community 7`, `Community 8`, `Community 137`, `Community 9`, `Community 11`, `Community 10`, `Community 265`, `Community 17`, `Community 24`, `Community 161`, `Community 162`, `Community 36`, `Community 40`, `Community 46`, `Community 47`, `Community 49`, `Community 61`, `Community 194`, `Community 82`, `Community 89`, `Community 95`, `Community 98`, `Community 108`, `Community 117`?**
